...
const BoardWriteCom = () => {
    ...
    if (!selectedProgress || selectedProgress == null) {
      try {
        const response = await axios.post(
          `https://planbee.p-e.kr/planbee/groups/${thisGroupId}/boards`,
          {
            postTitle: postTitle,
      ...
      switch (selectedProgress) {
        case "daily":
          try {
            const response = await axios.post(
              `https://planbee.p-e.kr/planbee/groups/${thisGroupId}/boards/daily`,
              {},
              {
                withCredentials: true,
              }
        ...
        case "weekly":
          try {
            const response = await axios.post(
              `https://planbee.p-e.kr/planbee/groups/${thisGroupId}/boards/weekly`,
              {},
              {
                withCredentials: true,
              }
  ...
  const handleMonthlyWinner = async () => {
    ...
    try {
      const response = await axios.post(
        `https://planbee.p-e.kr/planbee/groups/auto-post/${thisGroupId}`,
        {
          withCredentials: true,
        }
      );
