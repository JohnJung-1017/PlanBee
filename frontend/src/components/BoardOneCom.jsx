...
const BoardOneCom = ({ thisPostId, thisGroupId }) => {
  ...
  const fetchThisPost = async () => {
    try {
      const response = await axios.get(
        `https://planbee.p-e.kr/planbee/groups/${thisGroupId.thisGroupId}/boards/${thisPostId.id}`,
        { withCredentials: true }
      );
  ...
  const handleHit = async () => {
    try {
      await axios.put(
        `https://planbee.p-e.kr/planbee/groups/${thisGroupId.thisGroupId}/boards/${thisPostId.id}/hit`,
        {},
        { withCredentials: true }
      );
    } catch (error) {
  ...
  const handleAddReply = async () => {
    try {
      await axios.post(
        `https://planbee.p-e.kr/planbee/groups/${thisGroupId.thisGroupId}/boards/${thisPostId.id}/reply`,
  ...
  const handleAddNestedReply = async (parentReplyId) => {
    try {
      await axios.post(
        `https://planbee.p-e.kr/planbee/groups/${thisGroupId.thisGroupId}/boards/${thisPostId.id}/reply/${parentReplyId}`,
  ...
  const handleModiSaveReply = async (replyId) => {
    try {
      await axios.put(
        `https://planbee.p-e.kr/planbee/groups/${thisGroupId.thisGroupId}/boards/${thisPostId.id}/reply/${replyId}`,
